...
//         var a = $(this)[0];
//         a.getBoundingClientRect().top <= $(window).height() / 2 && $(a).find(".inner1").css("bottom", "0").css("opacity", "1")
//     }), 


//     $(".container2").each(function() {
//         var a = $(this)[0];
//         a.getBoundingClientRect().top <= $(window).height() / 2 && $(a).find("li").css("bottom", "0").css("opacity", "1")
